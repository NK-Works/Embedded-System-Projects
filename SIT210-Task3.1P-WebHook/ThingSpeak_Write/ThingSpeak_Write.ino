...
#define SECRET_SSID "WiFiName"   // Place your WiFi name here
#define SECRET_PASS "WiFiPassword"   // Place your WiFi password here

// Define the ThingSpeak channel ID and write API key
#define SECRET_CH_ID XXXXXXX   // Replace the Xx with your Channel ID/Number
#define SECRET_WRITE_APIKEY "YOUR_API_KEY" // Place your API Key here
